...
<?php do_action('jobify_share_before', $message); ?>
        ...
        <li class="whatsapp-share"><a data-text="Take a look at this awesome website:" data-link="<?php the_permalink(); ?>" class="whatsapp w3_whatsapp_btn w3_whatsapp_btn_large">
                <img src="<?php echo get_template_directory_uri();?>/images/whatsapp-icon.svg" alt="MAG Whatsapp"></a></li>		
