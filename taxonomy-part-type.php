...
<div class="container" id="featured-products">
    <div class="row">
        ...
        <div class="large-4 columns">
            <?php $cattype = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );?>
            <img src="https://maglaundryequipment.co.uk/wp-content/uploads/2015/10/logo-white.png">
        </div>
